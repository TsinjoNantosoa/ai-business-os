import {
  ...
  UserCircle, Network, UserPlus, DollarSign, Palmtree,
...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'nav.leaves', path: '/app/hr/leaves', icon: Palmtree, permissions: ['hr.leave.read', 'hr.employee.read'] },
    ],
  },
  {
    label: 'nav.support',
...
/** Flat list of all app nav paths (for audits / CEO visibility checks). */
